  ...
  return (
    <div className="page">
      <div className="page-header">
        <div className="page-title">PURCHASE VOUCHER</div>
      ...
      <div className="card">
        <div className="flex-between mb-12">
          <div className="card-title" style={{ marginBottom:0, borderBottom:'none', paddingBottom:0 }}>
            Gold Items Received from Customer
          </div>
      ...
      <div className="two-col">
        ...
        <div className="card">
          <div className="card-title">Amount Payable to Customer</div>
          <div className="calc-box">
            ...
            {obCash > 0 && (
              <div className="calc-row">
                <span className="calc-label" style={{ color:'var(--green)' }}>Pending OB (adjust)</span>
                <span className="calc-value" style={{ color:'var(--green)' }}>₹{obCash.toLocaleString('en-IN', { minimumFractionDigits:2 })}</span>
              </div>
            )}
      ...
      {lastSaved?._showPrint && (
        <PrintReceipt voucher={lastSaved} type="purchase"
